...
## Day 32 — Advanced Dynamic Programming: Subsequence / State DP

Day 32 focuses on Dynamic Programming states where the answer depends on a
sequence prefix or a compact state transition.
